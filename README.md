...
> `Template Gauge Card` has been renamed to `Gauge Card Pro` as the card is no longer just about _templates_ and to leave room for future development that are not template related.
>
