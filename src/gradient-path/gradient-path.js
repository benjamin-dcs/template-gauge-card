...
function requireTinygradient() {
   ...
   */ function interpolateHsv(stop1, stop2, steps, mode) {
    ...
    if (typeof mode === "boolean") {
      ...
      trigonometric =
        (mode === "long" && trigShortest) ||
        (mode === "short" && !trigShortest);
    }
    const step = stepize(start, end, steps);
...
var tinygradient = /*@__PURE__*/ getDefaultExportFromCjs(tinygradientExports); // An internal function to help with easily creating SVG elements with an object of attributes
